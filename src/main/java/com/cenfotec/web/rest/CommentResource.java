...
/**
 * REST controller for managing {@link com.cenfotec.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingComment -> {
                    if (comment.getiDComment() != null) {
                        existingComment.setiDComment(comment.getiDComment());
                    }
                    if (comment.getPostDate() != null) {
                        existingComment.setPostDate(comment.getPostDate());
                    }
