...
import com.cenfotec.repository.UserProfileRepository;
...
/**
 * REST controller for managing {@link com.cenfotec.domain.UserProfile}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingUserProfile -> {
                    if (userProfile.getiDUser() != null) {
                        existingUserProfile.setiDUser(userProfile.getiDUser());
                    }
                    ...
                    if (userProfile.getPlateNumber() != null) {
                        existingUserProfile.setPlateNumber(userProfile.getPlateNumber());
                    }
                    if (userProfile.getStatus() != null) {
                        existingUserProfile.setStatus(userProfile.getStatus());
                    }
                    if (userProfile.getType() != null) {
                        existingUserProfile.setType(userProfile.getType());
                    }
