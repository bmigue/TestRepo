...
import com.cenfotec.repository.ReservationRepository;
...
/**
 * REST controller for managing {@link com.cenfotec.domain.Reservation}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Reservation> result = reservationRepository
            ...
            .map(
                existingReservation -> {
                    ...
                    if (reservation.getResDateTime() != null) {
                        existingReservation.setResDateTime(reservation.getResDateTime());
                    }
