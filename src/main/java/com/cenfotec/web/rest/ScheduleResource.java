...
/**
 * REST controller for managing {@link com.cenfotec.domain.Schedule}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingSchedule -> {
                    if (schedule.getiDSchedule() != null) {
                        existingSchedule.setiDSchedule(schedule.getiDSchedule());
                    }
                    if (schedule.getInDateTime() != null) {
                        existingSchedule.setInDateTime(schedule.getInDateTime());
                    }
                    if (schedule.getOutDateTime() != null) {
                        existingSchedule.setOutDateTime(schedule.getOutDateTime());
                    }
