...
class ReservationResourceIT {
    ...
    private static final Integer DEFAULT_I_D_RESERVATION = 1;
    private static final Integer UPDATED_I_D_RESERVATION = 2;

    private static final ZonedDateTime DEFAULT_RES_DATE_TIME = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_RES_DATE_TIME = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public static Reservation createEntity(EntityManager em) {
        Reservation reservation = new Reservation()
            .iDReservation(DEFAULT_I_D_RESERVATION)
            .resDateTime(DEFAULT_RES_DATE_TIME)
    ...
    public static Reservation createUpdatedEntity(EntityManager em) {
        Reservation reservation = new Reservation()
            .iDReservation(UPDATED_I_D_RESERVATION)
            .resDateTime(UPDATED_RES_DATE_TIME)
    ...
    void createReservation() throws Exception {
        ...
        assertThat(testReservation.getiDReservation()).isEqualTo(DEFAULT_I_D_RESERVATION);
        assertThat(testReservation.getResDateTime()).isEqualTo(DEFAULT_RES_DATE_TIME);
    ...
    @Test
    @Transactional
    void checkiDReservationIsRequired() throws Exception {
    ...
    void getAllReservations() throws Exception {
        ...
        restReservationMockMvc
            ...
            .andExpect(jsonPath("$.[*].iDReservation").value(hasItem(DEFAULT_I_D_RESERVATION)))
            .andExpect(jsonPath("$.[*].resDateTime").value(hasItem(sameInstant(DEFAULT_RES_DATE_TIME))))
    ...
    void getReservation() throws Exception {
        ...
        restReservationMockMvc
            ...
            .andExpect(jsonPath("$.iDReservation").value(DEFAULT_I_D_RESERVATION))
            .andExpect(jsonPath("$.resDateTime").value(sameInstant(DEFAULT_RES_DATE_TIME)))
    ...
    void putNewReservation() throws Exception {
        ...
        updatedReservation.iDReservation(UPDATED_I_D_RESERVATION).resDateTime(UPDATED_RES_DATE_TIME).status(UPDATED_STATUS);
        ...
        Reservation testReservation = reservationList.get(reservationList.size() - 1);
        assertThat(testReservation.getiDReservation()).isEqualTo(UPDATED_I_D_RESERVATION);
        assertThat(testReservation.getResDateTime()).isEqualTo(UPDATED_RES_DATE_TIME);
    ...
    void partialUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.status(UPDATED_STATUS);
    ...
    void fullUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.iDReservation(UPDATED_I_D_RESERVATION).resDateTime(UPDATED_RES_DATE_TIME).status(UPDATED_STATUS);
