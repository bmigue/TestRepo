...
import com.cenfotec.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    private static final Integer DEFAULT_I_D_COMMENT = 1;
    private static final Integer UPDATED_I_D_COMMENT = 2;
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().iDComment(DEFAULT_I_D_COMMENT).postDate(DEFAULT_POST_DATE).comment(DEFAULT_COMMENT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().iDComment(UPDATED_I_D_COMMENT).postDate(UPDATED_POST_DATE).comment(UPDATED_COMMENT);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getiDComment()).isEqualTo(DEFAULT_I_D_COMMENT);
        assertThat(testComment.getPostDate()).isEqualTo(DEFAULT_POST_DATE);
    ...
    @Test
    @Transactional
    void checkiDCommentIsRequired() throws Exception {
    ...
    void getAllComments() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].iDComment").value(hasItem(DEFAULT_I_D_COMMENT)))
    ...
    void getComment() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.iDComment").value(DEFAULT_I_D_COMMENT))
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.iDComment(UPDATED_I_D_COMMENT).postDate(UPDATED_POST_DATE).comment(UPDATED_COMMENT);
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getiDComment()).isEqualTo(UPDATED_I_D_COMMENT);
        assertThat(testComment.getPostDate()).isEqualTo(UPDATED_POST_DATE);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.iDComment(UPDATED_I_D_COMMENT).comment(UPDATED_COMMENT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.iDComment(UPDATED_I_D_COMMENT).postDate(UPDATED_POST_DATE).comment(UPDATED_COMMENT);
